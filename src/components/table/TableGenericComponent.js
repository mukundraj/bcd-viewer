...
const TableGeneric = ({columns, tableDataSorted, maxCellTypes, width, handleSorting}) => {
    ...
    <div className="add-border floater" style={tableStyle(width)} ref={target}>
      ...
      >
        <table className="sctable">
          ...
          <TableBodyGeneric columns={columns} tableDataSorted={tableDataSorted.slice(0, maxCellTypes)} maxCellTypes={maxCellTypes}/>
        </table>
      </Scrollbars>
    </div>
  </>
